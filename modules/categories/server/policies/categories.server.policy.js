...
exports.isAllowed = function (req, res, next) {
  //if the user is logged on, give him user acces, otherwise give him guest permissions
  var roles = (req.user) ? ['user'] : ['guest'];

  // If a category is being processed and the current user created it then allow any manipulation
